...
#define Z_MIN_ENDSTOP_INVERTING true // MR Set to true to invert the logic of the endstop.
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // MR Set to true to invert the logic of the probe.
