 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0 // MR
#define BAUDRATE_2 250000   // MR :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // MR
#define Y_DRIVER_TYPE  TMC2209 // MR
#define Z_DRIVER_TYPE  TMC2208 // MR
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 295.00 // MR
  #define DEFAULT_bedKi 35.65  // MR
  #define DEFAULT_bedKd 610.21 // MR
...
#define Z_MIN_ENDSTOP_INVERTING false // MR Set to true to invert the logic of the endstop.
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // MR Set to true to invert the logic of the probe.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 418 } // MR
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 60, 25 } // MR

#define LIMITED_MAX_FR_EDITING        // MR Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
 ...
 */
#define DEFAULT_ACCELERATION          1500    // MR X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1500    // MR E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1500    // MR X, Y, Z acceleration for travel (non printing) moves
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // MR
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 4, -2.41 } // MR
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   5 // MR Z Clearance for Deploy/Stow
...
#define Z_HOMING_HEIGHT  10      // MR (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define X_BED_SIZE 220 // MR
#define Y_BED_SIZE 220 // MR

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -13 // MR
#define Y_MIN_POS -12 // MR
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 15 // MR
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 240 // MR
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z // MR
...
#define AUTO_BED_LEVELING_BILINEAR // MR
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 // MR
// #define ENABLE_LEVELING_AFTER_G28 //MR
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID // MR
 ...
 */
#define EEPROM_SETTINGS     // MR Persistent storage with M500 and M501
...
#define PREHEAT_1_TEMP_BED     70 // MR
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PTG" // MR
#define PREHEAT_2_TEMP_HOTEND 220 // MR
#define PREHEAT_2_TEMP_BED    70 // MR
...
//
#define ENCODER_PULSES_PER_STEP 4 // MR
...
//
#define REVERSE_ENCODER_DIRECTION // MR
...
//
#define REVERSE_MENU_DIRECTION // MR
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // MR
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 // MR
#define LCD_FEEDBACK_FREQUENCY_HZ 5000 // MR
