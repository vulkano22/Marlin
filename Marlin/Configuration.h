...
#define Z2_DRIVER_TYPE TMC2209 // MR
...
#define PIDTEMPBED // MR
  ...
  #define DEFAULT_bedKp 220.74 // MR
  #define DEFAULT_bedKi 41.45  // MR
  #define DEFAULT_bedKd 783.64 // MR
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 141.45 } // MR (E-steps for direct drive, for bovden value is 418)
...
#define LIMITED_MAX_FR_EDITING        // MR Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 100, 1000 } // ...or, set your own edit limits // MR
#endif
 ...
 */
#define DEFAULT_ACCELERATION          900    // X, Y, Z and E acceleration for printing moves // MR
#define DEFAULT_RETRACT_ACCELERATION  1500   // E acceleration for retracts // MR
#define DEFAULT_TRAVEL_ACCELERATION   900    // X, Y, Z acceleration for travel (non printing) moves // MR
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26.80, 3.80, -1.70 } // MR
...
#define XY_PROBE_FEEDRATE (120*60) // MR

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (15*60) // MR
